<?php
    ...
    */
    'attributes' => [
        ...
        'MenuItems.*.name' =>' ',
        'MenuItems.*.point' =>' ',
        'MenuItems.*.callback_url' =>' ',
        'PresentReplies.*.point' =>' ',
        'PresentReplies.*.text' =>' ',
        'config.*.field_name'=>' ',
        'config.*.placeholder'=>' ',
        'config.*.validation'=>' ',
    ...
    if( preg_match('/api\/projects/',request()->path()) && (request()->isMethod('post') || request()->isMethod('put'))){
        $count = count(request()->input('ProjectMessengers')) ?: 100;

        for($i = 0; $i <= $count; $i++){
            $validation['attributes']['ProjectMessengers.'. $i .'.gateway_id'] =    ' ';
            $validation['attributes']['ProjectMessengers.'. $i .'.permission_id'] = ' ';
            $validation['attributes']['ProjectMessengers.'. $i .'.messenger_id'] =  ' ';
            $validation['attributes']['ProjectMessengers.'. $i .'.bot_username'] =  ' ';
            $validation['attributes']['ProjectMessengers.'. $i .'.bot_name'] =      ' ';
            $validation['attributes']['ProjectMessengers.'. $i .'.phone'] =         ' ';
            $validation['attributes']['ProjectMessengers.'. $i .'.gateway_token'] = ' ';
            $validation['attributes']['ProjectMessengers.'. $i .'.bot_token'] =     ' ';
        }
    }
