...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getItem(id) {
                axios.get(configs.apiUrl + "/events/" + id).then(response=>{
                    if(response.data.success === true) {
            ...
            newItem(){
                axios.post(configs.apiUrl + "/events", this.item).then(response=>{
                    if(response.data.success === true) {
                        this.item = response.data.Event;
            ...
            updateItem(id){
                axios.put(configs.apiUrl + "/events/" + id, this.item).then(response=>{
                    if(response.data.success === true) {
                        this.item = response.data.Event;
                        this.$router.push({ name: 'event' });
                    }
